  ...
  return (
    <div class='space-y-4'>
      ...
      <div class='grid gap-3' style='grid-template-columns: repeat(auto-fill, minmax(190px, 1fr));'>
        ...
        <ConditionCard
          label='Indoor Temp'
          value={fmt(obs.tempIndoor, 1)}
          unit='°C'
          icon='wi-thermometer'
          topRight={indoorTopRight}
          bottomRight={indoorBottomRight}
        />
        <ConditionCard
          label='Rain'
          value={fmt(obs.rainRate, 1)}
          unit='mm/h'
          icon='wi-rain'
          topRight={rainTopRight}
          bottomRight={rainBottomRight}
        />
        <ConditionCard
          label='Humidity'
          value={fmt(obs.humidityOutdoor, 0)}
          unit='%'
          icon='wi-humidity'
          topRight={humTopRight}
          bottomRight={humBottomRight}
        />
        <ConditionCard
          label='Pressure'
          value={fmt(obs.pressureRelative, 1)}
          unit='hPa'
          icon='wi-barometer'
          topRight={presTopRight}
          bottomRight={presBottomRight}
        />
        <ConditionCard
          label='Wind Speed'
          value={fmt(obs.windSpeed, 1)}
          unit='m/s'
          icon='wi-strong-wind'
          topRight={windTopRight}
          bottomRight={windBottomRight}
        />
        <ConditionCard
          label='Wind Gust'
          value={fmt(obs.windGust, 1)}
          unit='m/s'
          icon='wi-windy'
      ...
      <div class='grid gap-3' style='grid-template-columns: repeat(auto-fill, minmax(190px, 1fr));'>
        <ConditionCard
          label='Dew Point'
          value={fmt(obs.tempDewpoint, 1)}
          unit='°C'
          icon='wi-raindrop'
          topRight={dewTopRight}
          bottomRight={dewBottomRight}
        />
        <ConditionCard
          label='UV Index'
          value={fmt(obs.uvIndex, 0)}
          icon='wi-day-sunny'
          topRight={uvTopRight}
        />
        <ConditionCard
          label='Solar Rad.'
          value={fmt(obs.solarRadiation, 0)}
          unit='W/m²'
          icon='wi-day-haze'
